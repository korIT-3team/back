...
public class SalesController {
  ...
  // API: 판매계획 조회 메서드 //
  @GetMapping("/sales-plan")
  public ResponseEntity<? super GetSalesPlanListResponseDto> getSalesPlanList (
    @RequestBody @Valid GetSalesPlanListRequestDto requestBody
  ) {
    ResponseEntity<? super GetSalesPlanListResponseDto> response = salesService.getSalesPlanList(requestBody);
    return response;
  }
