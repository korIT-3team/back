...
public interface UserService {
    ...
    ResponseEntity<? super GetSignInUserResponseDto> getSignInUser(String employeeCode);
    ResponseEntity<? super KakaoSignInResponseDto> KakaoSignIn(String id, KakaoSignInRequestDto requestBody);
}
